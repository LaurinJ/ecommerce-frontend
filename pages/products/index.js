  ...
  return (
    <div class="container mx-auto my-10 px-3">
      <div class="flex flex-wrap">
        <div class="xl:w-1/4 lg:w-1/3 px-3 relative">
          <div class="filter_box bg-gray-100">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 ml-auto text-red-600 lg:hidden"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
        ...
        <div class="w-full xl:w-3/4 lg:w-2/3 px-3">
          <div class="flex">
            <div class="lg:hidden">
              <button class="w-36 min-w-full bg-red-600 py-2.5 px-2.5 text-white rounded">
                Filter
              </button>
            </div>
            <div class="ml-auto">
              <select class="pl-5 pr-10 h-10 leading-10 bg-white border-2">
